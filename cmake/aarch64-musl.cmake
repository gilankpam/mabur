# ARM (aarch64) musl cross-compilation toolchain file.
#
...
# environment variables exported by tools/build-arm64.sh, which on this host
# resolve to Nix's own cross stdenv:
#   pkgsCross.aarch64-multiplatform.pkgsStatic.stdenv.cc
# (target triple aarch64-unknown-linux-musl). Nothing below is
# Bootlin-specific or Nix-specific — any aarch64-*-musl*-gcc/g++ pair works as
...
# this file works whether build-arm64.sh exports the Mabur-specific names or a
...
if(NOT CMAKE_C_COMPILER OR NOT CMAKE_CXX_COMPILER)
  message(FATAL_ERROR
    "aarch64-musl.cmake: no cross compiler found. Export MABUR_CROSS_CC/"
    "MABUR_CROSS_CXX (or CC/CXX) to the aarch64-*-musl*-gcc/g++ pair before "
    "configuring, e.g. via tools/build-arm64.sh.")
endif()

# CMAKE_FIND_ROOT_PATH: where to look for target libraries (libusb's static
# archive + headers), staged by build-arm64.sh under toolchain/staging via a
...
# environment; see build-arm64.sh for why (pkgsCross ... pkgsStatic.libusb1
# already provides a static aarch64/musl libusb).
#
