/* ported from waybeam_venc f956a52:include/venc_jpeg.h */
#ifndef VENC_JPEG_H
#define VENC_JPEG_H
...
/* mabur edit: handle_snapshot_jpeg() declaration deleted — it took an
 * HttpRequest* from the out-of-scope venc_httpd.h module (httpd is not
 * ported; see task-B2-brief.md). The definition in venc_jpeg.c is
 * deleted too. */
