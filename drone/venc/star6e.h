/* ported from waybeam_venc f956a52:include/star6e.h */
 ...
 * star6e and maruko libmi_venc.so; Maruko adds VeDev and therefore binds it
 * through its backend-specific loader. */
typedef struct {
