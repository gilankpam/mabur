...
// scan.log (scanlog 1) -- the channel-selection record in the debug-log
// session directory (spec 2026-09-13-auto-channel-select §7). Formats are
...
class ScanLog {
 public:
  ...
  void energy(double t_ms, int card, uint8_t ch, const ScoutEnergy& e,
