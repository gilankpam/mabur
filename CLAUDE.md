...
| 40 MHz (HT40): capacity, range vs 20 MHz, per-frame width, A-MPDU rate/width folding (`TxMode::no_agg`), standard pairs + spur channels, scouting a pair | `docs/bw40-sweep-findings-2026-09-23.md` ("Start here" section) |
